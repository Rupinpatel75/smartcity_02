...
function SidebarProviderBase({ children }: { children: React.ReactNode }) {
  ...
  const value = React.useMemo(
    ...
    [openMobile, isMobile, toggleSidebar, open],
  );
    ...
    return (
      <Tooltip>
        ...
        <TooltipContent
          side="right"
          align="center"
          hidden={openMobile === false || isMobile}
          {...tooltip}
        />
      </Tooltip>
    );
...
const SidebarProvider = SidebarProviderBase;
